...
CompaniesModule = __decorate([
    (0, common_1.Module)({
        providers: [companies_resolver_1.CompaniesResolver, companies_service_1.CompaniesService],
        imports: [typeorm_1.TypeOrmModule.forFeature([company_entity_1.Company]), request_module_1.RequestModule],
